...
from botorch.generation import gen_candidates_scipy#_process_scipy_result#, gen_candidates_scipy

logger = _get_logger()

TGenCandidates = Callable[[Tensor, AcquisitionFunction, Any], Tuple[Tensor, Tensor]]

def gen_candidates_scipy_forPL(
    ...
    """
    YAL: Customize scipy optimizer to output termination status. Copied from BoTorch library.
    """
    ...
    return clamped_candidates, batch_acquisition, res
